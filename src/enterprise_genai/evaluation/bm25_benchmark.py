...
def is_retrieval_eligible(
    ...
    return bool(case.answerable and case.relevance_judgments)
...
def run_bm25_benchmark(
    ...
    *,
        ...
        case_results.append(
            {
                ...
                "retrieved_positive_score": (len(results)),
    ...
    return {
        "benchmark_version": ("northstar-bm25-baseline-v1"),
        ...
        "bm25_parameters": {
            "k1": effective_config.k1,
            "b": effective_config.b,
        },
        "corpus": {
            "chunks": len(chunks.chunks),
            "average_document_length": (index.average_document_length),
            "unique_terms": len(index.document_frequency),
        },
        "evaluation": {
